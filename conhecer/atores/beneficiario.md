---
title: Beneficiário
description: Titular do serviço que acompanha etapas e dossiê sem assinar o contrato
---
...
O beneficiário **não** tem cadastro próprio. Nome, documento (opcional) e e-mail (opcional) ficam no serviço vinculado ao contrato, junto com o [tipo de serviço](/tipos-de-servico/) e a descrição do pedido.

## Papel na LGPD

O beneficiário é **titular** dos dados pessoais tratados no serviço. Detalhes: [Papéis no tratamento — titular](/privacidade/papeis#titular) e [Direitos do titular](/privacidade/direitos).

## No portal

- Acesso **somente leitura** para ver etapas e dossiê — não há botão de assinar nem de pagar.
- Entra pelo **link** enviado por e-mail após a ativação. Sem e-mail, **não há portal**.
- O portal só abre para contrato **ativo**; rascunho não gera tela de espera.

Detalhes: [Documentos e acesso](/telas/portal/documentos) e [Portal](/telas/portal/).
