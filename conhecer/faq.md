---
title: FAQ
description: Perguntas frequentes sobre acompanhamento, honorários, contrato e serviço Anexus
---

# FAQ

Perguntas frequentes sobre a plataforma, acompanhamento do caso, precificação e escopo.
...
Não. Trânsito é o primeiro [tipo de serviço](/tipos-de-servico/) documentado; outras áreas usam o tipo **Outro**, com o mesmo contrato, dossiê e portal. Visão de produto: [Plataforma](/plataforma).
...
A geração do documento no escopo contratado, a análise dos anexos necessários e a entrega no dossiê. Não inclui deslocamento, taxas do órgão nem a etapa seguinte após resultado desfavorável. Detalhes: [O que o honorário cobre](/precificacao/escopo).
...
Não. Nova instância = novo pedido. Ver [Escopo](/precificacao/escopo).

## O que acontece se a lei ou os parâmetros mudarem?

Contratos **já lacrados** mantêm o honorário acordado. Contratos **ainda não selados** usam a regra vigente no momento do fechamento. Ver [Trânsito — vigência](/precificacao/transito#vigencia-de-legislacao-e-parametros).
