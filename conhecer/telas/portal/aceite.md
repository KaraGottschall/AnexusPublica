...
O pagamento dos honorários (Stripe Checkout) também é interno. O retorno fica em `/app/contratos/{id}`. Após a confirmação, o contrato fica **ativo** e lacrado. Se houver e-mail do [beneficiário](/dominios/atores-beneficiario), a plataforma envia o link do portal.

Detalhes: [Assinatura e integridade](/dominios/contratos-assinatura) e [Lista e operações](/telas/contratos/lista).

## Próximo

- [Dossiê](/telas/portal/dossie) — o que o beneficiário vê depois da ativação
- [Pedido e valores](/dominios/contratos-pedido) — o que entra no cadastro
